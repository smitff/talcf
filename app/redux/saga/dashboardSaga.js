...
export function* addNewAddressWorker(action) {
  console.log(
    '🚀 ~ file: dashboardSaga.js ~ line 178 ~ function*addNewAddressWorker ~ action',
    action,
  );
  try {
    let token = yield call(getToken); // token
    console.log(
      '🚀 ~ file: dashboardSaga.js ~ line 181 ~ function*addNewAddressWorker ~ token',
      token,
    );
    let userId = yield call(getUserId);
    console.log(
      '🚀 ~ file: dashboardSaga.js ~ line 183 ~ function*addNewAddressWorker ~ userId',
      userId,
    );

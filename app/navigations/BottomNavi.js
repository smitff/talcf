        ...
        options={{
          ...
          tabBarIcon: ({color, size, focused}) => (
            <Image
              source={
                focused
                  ? require('../image/Path2.png')
                  : require('../image/Home_Deselected.png')
              }
        ...
        options={{
          tabBarIcon: ({color, size, focused}) => (
            ...
            <Image
              source={
                focused
                  ? require('../image/dollar1.png')
                  : require('../image/dollar.png')
              }
              style={{width: 22, height: 22}}
            />
          ),

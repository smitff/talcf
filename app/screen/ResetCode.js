      ...
      <>
        <View style={{ flex: 1, }}>
          ...
          <TouchableOpacity onPress={() => navigation.goBack()}>
            ...
            <Text style={{ fontSize: 12, color: "#FFFFFF" ,marginTop:15}}>Enter your 6 digit code below. Sent to your email id</Text>
            <Text style={{ fontSize: 14, color: "#FFFFFF", marginTop: 30, marginBottom: 15 }}>Code</Text>
            <View style={{ flexDirection: "row" ,}}>
              <View style={{ width: 48, height: 48, borderRadius: 10, backgroundColor: "#ffff" ,justifyContent:"center",alignItems:"center"}}>
                <TextInput
              ...
              <View style={{ width: 48, height: 48, borderRadius: 10, backgroundColor: "#ffff", marginLeft: 10,justifyContent:"center",alignItems:"center" }}>
                <TextInput

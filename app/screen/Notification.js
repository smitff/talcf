  ...
  const renderCard = ({item}) => (
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <TouchableOpacity style={{ position: 'absolute', right: 10, top: 10 }} onPress={() => removeNotificationItem()}>
                <Text>X</Text>
              </TouchableOpacity>
            </View>
            <Text
       ...
       notificationLoader ?
        ...
        :
         <FlatList
            ...
            ListEmptyComponent={() => <Text style={{alignSelf: 'center', marginTop: 20, fontSize: 24}}>No Notification Found</Text>}
        />
    }
    </SafeAreaView>
  );

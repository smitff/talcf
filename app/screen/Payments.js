...
export default function Login({navigation, route}) {
  ...
  handleResponse = data => {
    if (data.title === 'success') {
      ...
      Alert.alert('Payment Status', '  Complete  ', [
        {
          text: 'Go To Home',
      ...
      Alert.alert('Payment Status', '  Cancelled  ', [
        {
          text: 'Cancel',
  ...
  const payModal = () => {
    let url = `http://ec2-3-144-21-115.us-east-2.compute.amazonaws.com/payment?user_id=${
      userDetels.id
    }&order_total=${price}&payment_for=course&data={"course_id":${course_id},"course_date":"${date}","start_time":"${time?.slice(
      0,
      5,
    )}"}`;
    console.log('url', url);
            ...
            <View style={{marginLeft: 20}}>
              ...
              <Text
                style={{
                  ...
                  marginRight: heightPercentageToDP('20%'),
                }}>
                ${price}
              </Text>
            </View>

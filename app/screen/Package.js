    ...
    return (
      <View
              ...
              <View
                ...
                <Text style={{fontSize: 10, marginLeft: 14,color:"#FFFFFF",fontSize:10}}>{item.cycle} WEEK</Text>
              </View>
              <Text
                style={{
                  textAlign: 'center',
              ...
              <View style={{flexDirection: 'row', marginTop: 20}}>
                ...
                <TouchableOpacity
                  activeOpacity={1}
                  onPress={() =>navigation.navigate('Payments', {url: getPaymentURL(index),amount:planList[index].price})}
                  >
                  <View
                    style={{
                      width: 150,
